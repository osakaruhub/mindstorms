...
public class UltrasonicSensor extends Sensor
{
  ...
  private lejos.hardware.sensor.EV3UltrasonicSensor us;
  ...
  public UltrasonicSensor(SensorPort port)
  {
    ...
    us = new lejos.hardware.sensor.EV3UltrasonicSensor(getLejosPort());
  ...
  protected void init()
  {
    if (LegoRobot.getDebugLevel() >= SharedConstants.DEBUG_LEVEL_MEDIUM)
      DebugConsole.show("ul.init()");
  }

  protected void cleanup()
  {
    if (LegoRobot.getDebugLevel() >= SharedConstants.DEBUG_LEVEL_MEDIUM)
      DebugConsole.show("ul.cleanup()");
   ...
   * @return the reference of the lejos.hardware.sensor.EV3UltrasonicSensor
   */
